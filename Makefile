.PHONY: install validate test integration-test build build-labour-market build-retail-sales build-housing build-inflation build-gdp build-population clean
...
build: build-labour-market build-retail-sales build-housing build-inflation build-gdp build-population
